...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="${ctx!}/quote/css/bootstrap.min.css" rel="stylesheet">
    <#--<link href="${ctx!}/quote/css/font-awesome.css?v=4.4.0" rel="stylesheet">-->

    <link href="${ctx!}/quote/css/animate.css" rel="stylesheet">
    <link href="${ctx!}/quote/css/style.css?v=4.1.0" rel="stylesheet">
...
<#-- <div class="row">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-people">
                                            <a href="projects.html"><img alt="image" class="img-circle" src="${ctx!}/hadmin/img/a3.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle" src="${ctx!}/hadmin/img/a1.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle" src="${ctx!}/hadmin/img/a2.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle" src="${ctx!}/hadmin/img/a4.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle" src="${ctx!}/hadmin/img/a5.jpg"></a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-people">
                                            <a href="projects.html"><img alt="image" class="img-circle" src="${ctx!}/hadmin/img/a7.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle" src="${ctx!}/hadmin/img/a6.jpg"></a>
                                            <a href="projects.html"><img alt="image" class="img-circle" src="${ctx!}/hadmin/img/a3.jpg"></a>
                                        </td>
                                        <td class="project-actions">
                                            <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
    ...
    <div class="row" style="margin-top: 10%">
        <h2 style="text-align: center;font-weight: bold;font-size: 120px;color: #0F769F" class="panel padder-v item">家 庭 账 务 系 统</h2>
        <br>
        <#--<h5 style="text-align: center;padding-left: 44%;font-weight: bold;font-size: 20px">卢米埃影业票务开放平台</h5>-->

    </div>
</div>
<!-- 全局js -->
<#--<script src="${ctx!}/quote/js/jquery.min.js?v=2.1.4"></script>
<script src="${ctx!}/quote/js/bootstrap.min.js?v=3.3.6"></script>
<script src="${ctx!}/quote/js/plugins/layer/layer.min.js"></script>-->
<!-- Flot -->
<#--<script src="${ctx!}/quote/js/plugins/flot/jquery.flot.js"></script>
<script src="${ctx!}/quote/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="${ctx!}/quote/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="${ctx!}/quote/js/plugins/flot/jquery.flot.pie.js"></script>-->
<!-- 自定义js -->
<#--<script src="${ctx!}/quote/js/content.js"></script>-->
<!--flotdemo-->
